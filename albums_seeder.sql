...
values('Micheal Jackson','Thriller', 1982, 51.2,'Pop, post-disco, funk, rock'),
      ...
      ('Pink Floyd', 'Dark Side of the Moon', 1973, 24.8, 'Progressive Rock'),
      ...
      ('Micheal Jackson', 'Bad', 1987, 21.1, 'Pop, rhythm and blues, funk, rock'),
      ...
      ('Bruce Springsteen','Boon in the U.S.A.', 1984, 22, 'Heartland rock'),
      ...
      ('The Beatles', 'Sgt. Peppers''s Lonely Hearts Club Band', 1967, 18.3, 'Rock'),
      ('Micheal Jackson', 'Dangerous', 1991, 17, 'New jack swing, R&B, pop'),
